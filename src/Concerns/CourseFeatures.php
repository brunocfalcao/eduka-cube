...
trait CourseFeatures
{
    ...
    public function getMetasAttribute()
    {
        return [
            ...
            'name|twitter:image' => eduka_url($this->domain, Storage::url($this->filename_email_logo)),
            ...
            'property|og:image' => eduka_url($this->domain, Storage::url($this->filename_email_logo)),
